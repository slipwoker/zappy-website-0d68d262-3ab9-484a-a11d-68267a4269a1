document.addEventListener('DOMContentLoaded', function () {
  ...
  // Auto-discover elements with data-animate attribute
  const dataAnimateElements = document.querySelectorAll('[data-animate]');

  const allAnimatables = Array.from(
    new Set([...animatableElements, ...dataAnimateElements])
  );

  // Add base class for CSS transition hook
  allAnimatables.forEach(function (el) {
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          setTimeout(function () {
            ...
            el.classList.remove('scroll-animation-ready');
          }, parseInt(delay, 10));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0d68d262-3ab9-484a-a11d-68267a4269a1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0d68d262-3ab9-484a-a11d-68267a4269a1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0d68d262-3ab9-484a-a11d-68267a4269a1';
